...
\begin{document}
    ...
    \section[challenges]{high data dimensionality challenges}
		...
		\begin{frame}{dimensionality issues}{curse of dimensionality}
            ...
            \vspace{-8mm}
            \begin{center}
                \animategraphics[loop]{1}{animateCurseOfDimensionality/CurseOfDimensionality-}{00}{02}        
            \end{center}
            \end{columns}
            \addreference{matlab source: \href{https://github.com/alexanderlerch/ACA-Slides/blob/master/matlab/animateCurseOfDimensionality.m}{matlab/animateCurseOfDimensionality.m}}
                %\pause
    ...
    \section[mapping]{feature space transformation}
		...
		\begin{frame}{introduction}{PCA example}
            \only<1>{
                \textbf{pca input}
                \begin{figure}%
                    \includegraphics{PcaExample_input}
                \end{figure}
                \addreference{matlab source: \href{https://github.com/alexanderlerch/ACA-Slides/blob/master/matlab/displayPcaExample.m}{matlab/displayPcaExample.m}}
            }
            \only<2>{
                \textbf{pca output}
                \begin{figure}%
                    \includegraphics{PcaExample_output}
                \end{figure}
                \addreference{matlab source: \href{https://github.com/alexanderlerch/ACA-Slides/blob/master/matlab/displayPcaExample.m}{matlab/displayPcaExample.m}}
            }
             \only<3>{
            \textbf{pca eigenvalues}
                \begin{figure}%
                    \includegraphics{PcaExample_latent}
                \end{figure}
                \addreference{matlab source: \href{https://github.com/alexanderlerch/ACA-Slides/blob/master/matlab/displayPcaExample.m}{matlab/displayPcaExample.m}}
            }
            \only<4>{
