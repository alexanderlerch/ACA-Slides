...
\subtitle{Module 2.5: Fundamentals~---~Fourier Transform}
        ...
        \begin{frame}{introduction}{overview}
            ...
            \begin{itemize}
                ...
                \item<2->   \textbf{learning objectives}
                    \begin{itemize}
                        \item   remember definition and properties of the FT
                    \end{itemize}
            \end{itemize}
    ...
    \section[introduction]{introduction}
        \begin{frame}{fourier transform}{introduction}
            ...
            \begin{tabular}{lll}
                ...
                bottom & real spectrum & imaginery spectrum
            \end{tabular}
            \end{table}
...
%
    ...
    \section[STFT]{Short Time Fourier Transform}
        ...
        \begin{frame}{fourier transform}{STFT 2/2}
            \begin{center}
                \animategraphics[autoplay,loop]{2}{animateStft/Stft-}{001}{005}        
            \end{center}
            \addreference{matlab source: \href{https://github.com/alexanderlerch/ACA-Slides/blob/master/matlab/animateStft.m}{matlab/animateStft.m}}
            \inserticon{video}
        \end{frame}	
