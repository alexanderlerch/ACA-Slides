...
\begin{document}
    ...
    \section{key detection}
        ...
        \only<1>{
            ...
            \begin{enumerate}
                \item<2->	define reference distribution for specific keys
                \item<3->	extract average pitch chroma
            \end{enumerate}
            \only<2>{\vspace{-7mm}   \figwithmatlab{KeyProfiles}}
        \end{frame}
        ...
        \begin{frame}{key detection}{introduction 2/2}
            ...
            \begin{enumerate}
                \setcounter{enumi}{2}
                \item	compute distance between template and extracted chroma
                \videowithmatlab{KeyDetection}
            \end{enumerate}
        \end{frame}
